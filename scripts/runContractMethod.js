...
async function main() {
  // ABI قرارداد هوشمند را در اینجا وارد کنید
  const contractABI = [
	{
		"inputs": [
			{
  ...
  // آدرس قرارداد هوشمند را در اینجا وارد کنید
  const contractAddress = "0x...";

  // آدرس JSON-RPC شبکه را وارد کنید
  const provider = ethers.provider;

  // ایجاد شیء قرارداد هوشمند با ABI و آدرس مشخص شده
  const contract = new ethers.Contract(contractAddress, contractABI, provider);

  // اجرای متد قرارداد هوشمند
