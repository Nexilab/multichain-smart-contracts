...
contract DAIToken is ERC20Capped, ERC20Burnable, AccessControlEnumerable, PausableControl {
...
contract WrappedDai is DAIToken {
    ...
    constructor(
        ...
        address _admin,
        address _underlying
    ) DAIToken(_name, _symbol, _decimals, _cap, _admin) {
