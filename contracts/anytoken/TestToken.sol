...
contract TestToken is ERC20Capped, ERC20Burnable, AccessControlEnumerable, PausableControl {
...
contract WrappedTestToken is TestToken {
    ...
    constructor(
        ...
        address _admin,
        address _underlying
    ) TestToken(_name, _symbol, _decimals, _cap, _admin) {
